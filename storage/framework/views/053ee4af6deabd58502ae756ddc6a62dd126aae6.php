    ...
    <div class="container-fluid">
        <main class="container">
                ...
                <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="col-md-12">
                        ...
                        <div class="d-flex justify-content-between">
                            <span><?php echo e(count($article->comments)); ?> комментариев</span>
            ...
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('login')); ?>"><?php echo e(__('Войдите, чтобы создать свою статью')); ?></a>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/course.loc/blog/resources/views/index.blade.php ENDPATH**/ ?>