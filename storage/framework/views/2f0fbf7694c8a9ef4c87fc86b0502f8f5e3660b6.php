        ...
        <div class="row row-cols-1">
            <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="col-md-12">
                    ...
                    <a href="<?php echo e(route ('admin.article', [$article->id])); ?>" class="effect-lily tm-post-link tm-pt-20">
...
<?php echo $__env->make('admin.layouts.app_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/course.loc/blog/resources/views/admin/approve_article.blade.php ENDPATH**/ ?>