            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <a class="nav-link" href="<?php echo e(route('user.article')); ?>"><?php echo e(__('Создать статью')); ?> </a>
...
<?php /**PATH /var/www/course.loc/blog/resources/views/layouts/app.blade.php ENDPATH**/ ?>