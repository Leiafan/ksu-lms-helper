<?php $__env->startSection('content'); ?>
    <div class="container">
        <main class="container">
            ...
            <form action="<?php echo e(route('user.upload')); ?>" method="post" id="upload_form" role="form" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="container">
                    <div class="col-md-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/course.loc/blog/resources/views/user/upload_article.blade.php ENDPATH**/ ?>