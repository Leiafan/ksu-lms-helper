<?php $__env->startSection('content'); ?>
    <div class="container">
        <main class="container">
            <form action="<?php echo e(route('user.upload')); ?>" class="mb-5 tm-comment-form" method="post" id="upload_article" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="container">
                    <div class="col-md-12">
...
<?php echo $__env->make('moderator.layouts.app_moderator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/course.loc/blog/resources/views/moderator/upload_article.blade.php ENDPATH**/ ?>